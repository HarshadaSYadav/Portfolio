      ...
      <ChevronDown size={32} className="mx-auto text-gray-400 dark:text-gray-500 animate-bounce" />
        ...
        >
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl font-bold text-center text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 to-purple-500 mb-12">Contact</h2>
            <div className="grid md:grid-cols-2 gap-8">
              <div className="space-y-6">
                <div className="flex items-center space-x-4 group">
                  <Mail className="text-indigo-500 group-hover:scale-110 transition-transform duration-300" size={24} />
                  <a href="mailto:harshadayadav13@gmail.com" className="text-gray-600 dark:text-gray-300 hover:text-indigo-500 dark:hover:text-indigo-400 transition-colors duration-200">
                    harshadayadav13@gmail.com
                  </a>
                </div>
                <div className="flex items-center space-x-4 group">
                  <Phone className="text-indigo-500 group-hover:scale-110 transition-transform duration-300" size={24} />
                  <a href="tel:+918668823575" className="text-gray-600 dark:text-gray-300 hover:text-indigo-500 dark:hover:text-indigo-400 transition-colors duration-200">
                    +91 8668823575
                  </a>
                </div>
                <div className="flex items-center space-x-4 group">
                  <MapPin className="text-indigo-500 group-hover:scale-110 transition-transform duration-300" size={24} />
                  <span className="text-gray-600 dark:text-gray-300">Sangli, Maharastra</span>
                </div>
                <div className="flex items-center space-x-4 group">
                  <Github className="text-indigo-500 group-hover:scale-110 transition-transform duration-300" size={24} />
                  <a
                    href="https://github.com/HarshadaSYadav"
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <div className="flex items-center space-x-4 group">
                  <Linkedin className="text-indigo-500 group-hover:scale-110 transition-transform duration-300" size={24} />
                  <a
                    href="https://www.linkedin.com/in/harshadayadav13"
                    target="_blank"
                    rel="noopener noreferrer"
              ...
              <form className="space-y-6">
                <div>
                  ...
                  <input
                    type="text"
                    id="name"
                    className="mt-1 block w-full rounded-lg border-gray-300 dark:border-gray-600 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:text-white transition-colors duration-200"
                  />
                </div>
                <div>
                ...
                <button
                  type="submit"
                  className="w-full bg-gradient-to-r from-indigo-500 to-purple-500 text-white py-2 px-4 rounded-lg hover:from-indigo-600 hover:to-purple-600 transform hover:scale-105 transition-all duration-300"
                >
                  Send Message
                </button>
              </form>
